  ...
  '$compile', '$document', function ($compile, $document) {
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        template = '<div class="context-menu"> <ul class="dropdown-menu" role="menu"> <li ng-click="clickItem(item, $event)" ng-repeat="item in menu"> <hr ng-if="item.type==\'hr\'"  /> <a href="javascript:void(0)" ng-if="item.type!=\'hr\'">{{item[options.itemLabel]}}</a> </li> </ul> </div>';
